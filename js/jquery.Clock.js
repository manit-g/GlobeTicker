(function( $ ) {
    ...
    $.fn.Clock = function(options) {
       ...
       defaults = {
            ...
            el.utc_offset   =   settings.utc_offset;
            ...
            function startClock(x,y,utc_off){
                var theDate,
                    s,
                    m,
                    hours,
                ...
                if(utc_off !== 100) {
                    ...
                    theDate = new Date(utc + (3600000*utc_off));
                }
                ...
                setTimeout(function(){startClock(x,y,utc_off);},synced_delay);
            }
            startClock(x,y,el.utc_offset);
